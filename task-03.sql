...
-- In the Categories table, select * from Categories will return 4 columns. 
-- We only want to see two columns, CategoryName and Description.

SELECT CategoryName, Description
FROM Categories

-- Given the table Employees We’d like to see just the FirstName, LastName, and HireDate 
-- of all the employees with the value 'Sales Representative' in the  Title field. 
